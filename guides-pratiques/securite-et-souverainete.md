---
description: Comprendre la sécurité et la souveraineté de l'Assistant IA
icon: shield-check
---
...
* [**Protection des données**](../documentation-legale/data-protection.md) - Tous les détails sur le traitement de vos données
