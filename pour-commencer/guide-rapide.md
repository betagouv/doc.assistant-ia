...
L'assistant affichera sa réponse en temps réel. Vous pouvez lire, copier ou évaluer la réponse avec 👍 ou 👎.
{% endstep %}
{% endstepper %}
...
### 🎯 Objectif : Apprendre à formuler des questions pour obtenir de meilleurs résultats
...
Contexte : Mon collègue ne connaît rien au RGPD.
Question : Peux-tu faire une explication simple avec des exemples concrets ?
```

**Astuce :** Plus vous donnez de **contexte** et de **précisions**, meilleures seront les réponses.

### Conseils pour de meilleures réponses

1. **Soyez spécifique** : Plus votre question est précise, meilleure sera la réponse
2. **Donnez du contexte** : Expliquez brièvement pourquoi vous posez la question
3. **Posez une question à la fois** : Évitez les questions trop larges
...
Pour obtenir des informations actualisées, **cliquez sur l'icône 🌐** dans la barre de saisie.
{% endstep %}
...
L'Assistant effectuera une recherche sur le web avant de générer sa réponse.
{% endstep %}

{% step %}
#### Alternative : Recherche intelligente

Dans vos **paramètres**, vous pouvez activer la **"recherche intelligente"** pour que l'Assistant décide automatiquement quand effectuer une recherche.
{% endstep %}
{% endstepper %}
...
Cliquez sur **"Nouvelle conversation"** pour démarrer un nouvel échange.
{% endstep %}

{% step %}
#### Naviguer entre les conversations

Dans la **barre latérale**, cliquez sur une conversation pour y revenir. Utilisez la **barre de recherche** en haut pour trouver un échange spécifique.
{% endstep %}

{% step %}
#### Renommer une conversation

1. Cliquez sur les **trois points (⋮)** à côté du nom de la conversation
...
Les **projets** vous permettent de créer des espaces de travail organisés avec des **instructions communes** appliquées automatiquement.
{% endstep %}
...
{% step %}
#### Créer une conversation dans le projet

1. Sélectionnez le projet dans la barre latérale.
2. Verifiez que le nom du projet est bien indiqué au dessus de la barre de saisie.
3. Posez une question liée au projet.
4. **Observez** : L'Assistant adopte automatiquement le style défini dans l'instruction du projet
{% endstep %}
{% endstepper %}
